...
export const siteConfig = {
  ...
  profile: {
    ...
    bio: '約 12 年の Web 開発経験を持つフリーランスエンジニアです。Next.js / React / TypeScript を中心としたフロントエンドを軸に、Rust や Hono などバックエンドにも領域を広げ、要件の整理から設計・実装・改善までを一貫して推進します。「価値のあるソフトウェアを早く継続的に提供する」というアジャイル原則を行動指針に、お客様に持続的に価値を届けることを大事にしています。',
